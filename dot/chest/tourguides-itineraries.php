          ...
          <div class="ui fluid card">
            ...
            <div class="content">
              ...
              <div class="ui green message">
                ...
                You are viewing the Tour Guides itineraries
              </div>
            </div>
            <div class="extra content">
              <a href="destinations-itineraries.php" class="">View Destinations Itineraries</a>
              <a href="travelers-itineraries.php" class="right floated">View Travelers Itineraries</a>
            </div>
          </div>
        </div>
