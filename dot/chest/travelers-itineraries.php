          ...
          <div class="ui fluid card">
            ...
            <div class="content">
              ...
              <div class="ui green message">
                ...
                You are viewing the travelers itineraries
              </div>
            </div>
            <div class="extra content">
              <a href="tourguides-itineraries.php" class="">View Tourguides Itineraries</a>
              <a href="destinations-itineraries.php" class="right floated">View Destinations Itineraries</a>
            </div>
          </div>
        </div>
